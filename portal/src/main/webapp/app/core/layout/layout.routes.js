           ...
           .constant('routes',
                     [{
                         ...
                         config: {
                             ...
                             views : {
                        		 'lockedView':{
                        			 templateUrl: '/portal/app/core/errors/404.html'
                        		 }
                        	 }
                         }
                     }, {
                         ...
                         config: {
                             url: '/500',
                             templateUrl: '/portal/app/core/errors/500.html'
                         }
                     }, {
                         name: 'Not Authorized', 
                         config: {
                             url: '/401',
                             templateUrl: '/portal/app/core/errors/401.html',
                         ...
                         config: {
                        	 ...
                        	 views : {
                        		 'lockedView':{
                        			 templateUrl: '/portal/app/core/errors/403.html'
                        		 }
                        	 }
                         }
                     }, {
                         ...
                         config: {
                             ...
                             templateUrl: '/portal/app/core/errors/noState.html',
                         ...
                         config: {
                        	 ...
                        	 views : {
                        		 'lockedView':{
                                     templateUrl: '/portal/app/core/auth/login.html',
                         ...
                         name: 'forgotPass', config: {
                        	 ...
                        	 views : {
                        		 'lockedView':{
                                     templateUrl: '/portal/app/core/auth/forgot-password.html',
                         ...
                         name: 'resetPass', config: {
                        	 ...
                        	 views : {
                        		 'lockedView':{
                                     templateUrl: '/portal/app/core/auth/resetPass.html',
